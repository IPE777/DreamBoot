<template>
  <el-form :model="contentForm" :rules="rules" ref="contentForm" label-width="100px" class="demo-ruleForm">
    ...
    <el-form-item>
      <el-button type="primary" @click="submitForm('contentForm')">立即修改</el-button>
...
export default {
  ...
  created() {
    const _this = this
    axios.get('http://localhost:7777/content/findById/'+this.$route.query.id).then(function (resp){
